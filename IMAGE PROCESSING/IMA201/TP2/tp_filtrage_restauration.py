...
#%% charger une image 
im=skio.imread('IMA/TP1/lena.tif')
...
file_path = r'C:\Users\giova\OneDrive\Área de Trabalho\IMA\TP2\lena.tif'
im=skio.imread(file_path)
import matplotlib.pyplot as plt
arg = rotation(im,theta = 45 ,alpha,x0=None,y0=None,ech=0,clip=True)

'''for i in range(8): 
    arg = rotation(arg, 45, True,alpha = 1/2,  ech = 0)'''
plt.imshow(arg,  cmap='gray')
plt.axis('off')

# %%3
import matplotlib.pyplot as plt
file_path = r'C:\Users\giova\OneDrive\Área de Trabalho\IMA\TP2\carre_orig.tif'
im=skio.imread(file_path)
print(var_image(filtre_lineaire(noise(im,5), get_gau_ker(2)), 0,0,50,50))
print(var_image((noise(im,5)), 0,0,50,50))
arg = filtre_lineaire(noise(im, 5), get_gau_ker(2))
plt.imshow(im,  cmap='gray')

plt.show()
plt.imshow(noise(im,5),  cmap='gray')
plt.axis('off')
plt.show()
plt.imshow(arg,  cmap='gray')
plt.axis('off')
plt.show()
arg = median_filter(noise(im, 5))
plt.imshow(arg,  cmap='gray')
plt.axis('off')
plt.show()
#plt.imshow(arg,  cmap='gray')
...
plt.imshow(im,  cmap='gray')
plt.axis('off')
plt.imshow(noise(im, 10),  cmap='gray')
plt.axis('off')'''

# %%4
file_path = r'C:\Users\giova\OneDrive\Área de Trabalho\IMA\TP2\pyra-impulse.tif'
im=skio.imread(file_path)
arg = noise((filtre_lineaire(im, get_gau_ker(2))), 1)
...
arg = filtre_inverse(arg, get_gau_ker(2))
plt.imshow(arg,  cmap='gray')
plt.axis('off')
plt.show()

# %%54 pt. 2
file_path = r'C:\Users\giova\OneDrive\Área de Trabalho\IMA\TP2\carre_flou.tif'
im=skio.imread(file_path)
#plt.imshow(im,  cmap='gray')
plt.imshow(im,  cmap='gray')
plt.axis('off')
plt.show()
plt.imshow(filtre_lineaire(im, np.array([[0,0,1],[1,1,1], [0,0,1]])), cmap='gray')
plt.axis('off')
plt.show()
file_path = r'C:\Users\giova\OneDrive\Área de Trabalho\IMA\TP2\carre_orig.tif'
im=skio.imread(file_path)
...
plt.show()
# %%4 pt.3
file_path = r'C:\Users\giova\OneDrive\Área de Trabalho\IMA\TP2\bat.tif'
im=skio.imread(file_path)
im = noise(im, 5)

for i in range(0,60,15):
    plt.imshow(wiener(im, K = get_gau_ker(2), lamb = i),  cmap='gray')
    plt.axis('off')
    plt.show()
...
im = noise(im, 5)
long = 100
median_var = var_image(median_filter(im, typ=2, r=4), 0,0,50,50)
for i in range(1,50):
    linear_var = var_image(filtre_lineaire(im, get_cst_ker(i)), 0,0,50,50)
